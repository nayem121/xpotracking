...
export const metadata = {
  title: "Privacy Policy - Xpo Tracking: Logistic Tracker App",
  description:
    "Privacy policy for the Xpo Tracking: Logistic Tracker mobile application developed by Youth Empowerment Center.",
}
      ...
      <main className="container mx-auto px-4 py-12">
        <Card className="max-w-4xl mx-auto">
          <CardHeader className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-2">Xpo Tracking: Logistic Tracker App</p>
            <p className="text-sm text-gray-500 dark:text-gray-400">Effective Date: July 31, 2025</p>
          </CardHeader>
          <CardContent className="prose prose-gray dark:prose-invert max-w-none">
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              This privacy policy applies to the Xpo Tracking: Logistic Tracker app (hereby referred to as
              "Application") for mobile devices that was created by Youth Empowerment Center (hereby referred to as
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-6">
              <p className="text-amber-800 dark:text-amber-200 text-sm">
                ...
                endorsed by any specific logistics company or courier service. We are an independent service provider
                offering tracking functionality for various logistics parcels.
              </p>
            </div>
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <li>Logistics tracking numbers and consignment numbers you enter for parcel tracking purposes</li>
            </ul>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
